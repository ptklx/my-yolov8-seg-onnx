...
class YOLOv8:
    ...
    def main(self):
        ...
        mask_alpha=0.4
        result_image = draw_detections(image, self.boxes, self.scores,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="yolov8_text/yolov8s-seg.onnx", help="Input your ONNX model.")
    # parser.add_argument("--img", type=str, default=str(ASSETS / "bus.jpg"), help="Path to input image.")
    parser.add_argument("--img", type=str, default="image/bottle.jpg", help="Path to input image.")
    ...
    cv2.imwrite("./image/onnx_test.jpg",output_image)
